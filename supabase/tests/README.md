...
| `17_mannschaften.sql` | Mannschaften anlegen, Zuordnung und Mannschaftsführer, Archivierung |
| `99_runtests.sql` | Führt die Suite aus |

Die Dateien `01` bis `17` **definieren nur Funktionen**. Ausgeführt wird alles in
